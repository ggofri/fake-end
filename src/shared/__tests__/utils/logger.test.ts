import { setVerbose, verboseLog, verboseError, verboseWarn } from '../../utils/logger';
...
describe('Logger Utils', () => {
  ...
  describe('verboseLog', () => {
    ...
    it('should handle multiple arguments', () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith('Message: 123 [object Object] 1,2,3');
    });
    ...
    it('should handle complex objects', () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith('Complex object: [object Object]');
    });
  ...
  describe('verboseError', () => {
    ...
    it('should handle multiple arguments', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('Critical error: Error: Test error 500');
    });
    ...
    it('should handle stack traces', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining('Error with stack: Error: Stack trace test'));
    });
  });
  ...
  describe('verboseWarn', () => {
    ...
    it('should handle objects and arrays', () => {
      ...
      expect(consoleWarnSpy).toHaveBeenCalledWith('Warning data: [object Object]');
    });
