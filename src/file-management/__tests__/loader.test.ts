import { loadMockEndpoints } from '../loader/loader';
...
jest.mock('../loader/ts-loader', () => ({
  loadTypeScriptEndpoints: jest.fn()
}));

jest.mock('../path-builder/path-builder', () => ({
...
jest.mock('@/request-processing/validators', () => ({
...
import { buildEndpointPath } from '../path-builder/path-builder';
import { verboseLog, verboseError, verboseWarn } from '@/shared/utils';
import { isArrayOfMockEndpoints } from '@/mock-generation';
import { isValidEndpoint } from '@/request-processing/validators';
