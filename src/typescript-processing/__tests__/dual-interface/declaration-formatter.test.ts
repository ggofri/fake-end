import { generateFieldDeclaration } from '@/typescript-processing/dual-interface/declaration-formatter';
import { TypeScriptField } from '@/mock-generation/utils/typescript-generator';
